...
| [Semaphore](semaphore.md) | 107 | 192.168.1.27 | `semaphore.internal` | semaphore.welpes.com |
| [Forgejo](forgejo.md) | 108 | 192.168.1.28 | `forgejo.internal` | forgejo.welpes.com |
...
Notes:
- LXC 107/108 (Semaphore/Forgejo) kept their original `.27`/`.28` IPs from
  an earlier addressing scheme — every other service is `.10x`/`.11x`.
